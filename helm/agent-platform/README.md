...
| components.kagent.omitKeys[2] | string | `"oauth2ProxyIngress"` |  |
...
| components.agent-platform-connectivity.omitKeys[0] | string | `"backstage"` |  |
| components.agent-platform-connectivity.omitKeys[1] | string | `"mcp-kubernetes"` |  |
| components.agent-platform-connectivity.omitKeys[2] | string | `"cloudnative-pg"` |  |
| components.agent-platform-connectivity.omitKeys[3] | string | `"kserve-crd"` |  |
