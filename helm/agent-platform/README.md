...
| components.kserve-crd.versionRange | string | `"0.4.x"` |  |
...
| components.kserve-resources.versionRange | string | `"0.4.x"` |  |
...
| components.kserve-llmisvc-crd.versionRange | string | `"0.4.x"` |  |
...
| components.kserve-llmisvc-resources.versionRange | string | `"0.4.x"` |  |
...
| components.kserve-runtime-configs.versionRange | string | `"0.4.x"` |  |
