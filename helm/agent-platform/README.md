...
| components.muster.versionRange | string | `"2.x"` |  |
...
| components.valkey.enabledFrom | string | `"valkey.enabled"` |  |
...
| components.kagent.enabledFrom | string | `"kagent.enabled"` |  |
...
| components.klaus-gateway.enabledFrom | string | `"klausGateway.enabled"` |  |
