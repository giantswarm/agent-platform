...
| components.kserve-llmisvc-crd.versionRange | string | `"0.7.x"` |  |
...
| components.kserve-llmisvc-resources.versionRange | string | `"0.7.x"` |  |
...
| components.kserve-runtime-configs.versionRange | string | `"0.7.x"` |  |
...
| kserve-runtime-configs.kserve.llmisvcConfigs.rolloutStrategy.maxUnavailable | int | `1` |  |
