...
verify-meta: ## Assert the app-of-apps meta-package render (pure renderer with the engine off, ranges as values, Flux the only engine, pinned BOM).
	...
	@echo "--> mirrored egress defaults: the meta chart's copy of every networkPolicy fqdns / cidrs list equals the connectivity chart's default — the forwarded copy shadows the child's (#522)"
