...
LINE = {
    ...
    # 0.20.0 is the first vm-manager release from the generated CircleCI
    # pipeline (gsoci, the catalog). muster alone: the MCPServer CR.
    "vm-manager": (GSOCI, ">=0.20.0 <1.0.0", ["muster"]),
